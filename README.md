...
> **Note**
> Everywhere in this repository, make sure to replace `bayazidbh/ublue-kinoite-customized` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/bayazidbh/ublue-kinoite-customized/blob/main/scripts/README.md) for more information.
